...
public class PersonajeTest {
	...
	public void enfrentamientoPorVelocidadTest() {
		...
		Assert.assertEquals(true, p1.esGanador(p2, Caracteristica.VELOCIDAD));
	...
	public void enfrentamientoPorFuerzaTest() {
		...
		Assert.assertEquals(true, p2.esGanador(p1, Caracteristica.FUERZA));
	...
	public void enfrentamientoPorDestrezaTest() {
		...
		Assert.assertEquals(true, p2.esGanador(p1, Caracteristica.DESTREZA));
	...
	public void enfrentamientoPorVelocidadEmpataDefinePorFuerza() {
		...
		Combatiente p2 = new Villano("Coronel Rhoades", "Maquina de guerra",
				50, 98, 98, 96);
		...
		Assert.assertEquals(false, p2.esGanador(p1, Caracteristica.VELOCIDAD));
	...
	public void enfrentamientoPorFuerzaEmpataDefinePorDestreza() {
		...
		Assert.assertEquals(false, p2.esGanador(p1, Caracteristica.FUERZA));

	}

	@Test
	public void enfrentamientoPorResistenciaEmpataDefinePorDestreza() {
		Combatiente p1 = new Heroe("Steve Rogers", "Capitan America", 50, 98,
				90, 84);
		Combatiente p2 = new Villano("Bucky Barnes", "Soldado del Invierno",
				50, 98, 90, 96);
	...
	public void enfrentamientoEmpataEnTodosLosAspectos() {
		Combatiente p1 = new Heroe("Steve Rogers", "Capitan America", 50, 98,
				90, 96);
		Combatiente p2 = new Villano("John Walker", "Capitan America", 50, 98,
				90, 96);
		...
		Assert.assertEquals(false, p2.esGanador(p1, Caracteristica.DESTREZA));
